...
<template>
    <div class="slick-track" style="opacity: 1; width: 2698px;" role="listbox">
        <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80--- slick-slide" data-bs-bg="/img/slider/1.jpg" data-slick-index="0" style="background-image: url(&quot;/img/slider/1.jpg&quot;); width: 1349px; position: relative; left: 0px; top: 0px; z-index: 998; opacity: 0; transition: opacity 300ms linear 0s;" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide00">
